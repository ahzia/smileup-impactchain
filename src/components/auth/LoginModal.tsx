...
import { User, Lock, Mail, Eye, EyeOff, LogIn, Sparkles, Heart, Target, TrendingUp, UserPlus } from 'lucide-react';
...
interface LoginModalProps {
  ...
  showCreateAccountLink?: boolean; // New prop to show create account link
}

export function LoginModal({ isOpen, onClose, onLoginSuccess, showCreateAccountLink = false }: LoginModalProps) {
  const { login } = useAuth();
            ...
            >
              <Card className="bg-gradient-to-br from-card via-card/95 to-card border-border/50 backdrop-blur-sm shadow-2xl">
                ...
                <CardContent className="space-y-6">
                  ...
                  {/* Create Account Link - only show when showCreateAccountLink is true */}
