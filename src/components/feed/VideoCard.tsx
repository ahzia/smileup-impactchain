            ...
            >
              {post.community ? (
                <div className="relative">
                  <div className="w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 rounded-full overflow-hidden border-2 border-white/80 shadow-md lg:group-hover:border-white lg:group-hover:shadow-xl transition-all duration-300">
                    <img
